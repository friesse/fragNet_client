...
PROTOBUF_CONSTEXPR CMsgUpdateItemSchema::CMsgUpdateItemSchema(
  ...
  , /*decltype(_impl_.items_game_url_deprecated2013_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
const uint32_t TableStruct_base_5fgcmessages_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::CMsgUpdateItemSchema, _impl_.items_game_url_deprecated2013_),
...
const ::_pbi::DescriptorTable descriptor_table_base_5fgcmessages_2eproto = {
    false, false, 8707, descriptor_table_protodef_base_5fgcmessages_2eproto,
...
CMsgUpdateItemSchema::CMsgUpdateItemSchema(const CMsgUpdateItemSchema& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.items_game_url_deprecated2013_){}
  ...
  _impl_.items_game_url_deprecated2013_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.items_game_url_deprecated2013_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_items_game_url_deprecated2013()) {
    _this->_impl_.items_game_url_deprecated2013_.Set(from._internal_items_game_url_deprecated2013(), 
      _this->GetArenaForAllocation());
  }
...
inline void CMsgUpdateItemSchema::SharedDtor() {
  ...
  _impl_.items_game_url_deprecated2013_.Destroy();
...
// @@protoc_insertion_point(message_clear_start:CMsgUpdateItemSchema)
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _impl_.items_game_url_deprecated2013_.ClearNonDefaultToEmpty();
    }
    if (cached_has_bits & 0x00000004u) {
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "CMsgUpdateItemSchema.items_game_url_DEPRECATED2013");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
...
void CMsgUpdateItemSchema::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000000fu) {
    ...
    if (cached_has_bits & 0x00000002u) {
      _this->_internal_set_items_game_url_deprecated2013(from._internal_items_game_url_deprecated2013());
    }
    if (cached_has_bits & 0x00000004u) {
...
void CMsgUpdateItemSchema::InternalSwap(CMsgUpdateItemSchema* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.items_game_url_deprecated2013_, lhs_arena,
      &other->_impl_.items_game_url_deprecated2013_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
