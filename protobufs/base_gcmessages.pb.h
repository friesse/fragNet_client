...
class CMsgUpdateItemSchema final :
 ...
 public:
  ...
  enum : int {
    ...
    kItemsGameUrlDEPRECATED2013FieldNumber = 3,
  ...
  private:
  bool _internal_has_items_game_url_deprecated2013() const;
  public:
  void clear_items_game_url_deprecated2013();
  const std::string& items_game_url_deprecated2013() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_items_game_url_deprecated2013(ArgT0&& arg0, ArgT... args);
  std::string* mutable_items_game_url_deprecated2013();
  PROTOBUF_NODISCARD std::string* release_items_game_url_deprecated2013();
  void set_allocated_items_game_url_deprecated2013(std::string* items_game_url_deprecated2013);
  private:
  const std::string& _internal_items_game_url_deprecated2013() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_items_game_url_deprecated2013(const std::string& value);
  std::string* _internal_mutable_items_game_url_deprecated2013();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr items_game_url_deprecated2013_;
...
// optional string items_game_url_DEPRECATED2013 = 3;
inline bool CMsgUpdateItemSchema::_internal_has_items_game_url_deprecated2013() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CMsgUpdateItemSchema::has_items_game_url_deprecated2013() const {
  return _internal_has_items_game_url_deprecated2013();
}
inline void CMsgUpdateItemSchema::clear_items_game_url_deprecated2013() {
  _impl_.items_game_url_deprecated2013_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline const std::string& CMsgUpdateItemSchema::items_game_url_deprecated2013() const {
  ...
  return _internal_items_game_url_deprecated2013();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void CMsgUpdateItemSchema::set_items_game_url_deprecated2013(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
 _impl_.items_game_url_deprecated2013_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* CMsgUpdateItemSchema::mutable_items_game_url_deprecated2013() {
  std::string* _s = _internal_mutable_items_game_url_deprecated2013();
  // @@protoc_insertion_point(field_mutable:CMsgUpdateItemSchema.items_game_url_DEPRECATED2013)
  return _s;
}
inline const std::string& CMsgUpdateItemSchema::_internal_items_game_url_deprecated2013() const {
  return _impl_.items_game_url_deprecated2013_.Get();
}
inline void CMsgUpdateItemSchema::_internal_set_items_game_url_deprecated2013(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.items_game_url_deprecated2013_.Set(value, GetArenaForAllocation());
}
inline std::string* CMsgUpdateItemSchema::_internal_mutable_items_game_url_deprecated2013() {
  _impl_._has_bits_[0] |= 0x00000002u;
  return _impl_.items_game_url_deprecated2013_.Mutable(GetArenaForAllocation());
}
inline std::string* CMsgUpdateItemSchema::release_items_game_url_deprecated2013() {
  ...
  if (!_internal_has_items_game_url_deprecated2013()) {
    return nullptr;
  }
  _impl_._has_bits_[0] &= ~0x00000002u;
  auto* p = _impl_.items_game_url_deprecated2013_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.items_game_url_deprecated2013_.IsDefault()) {
    _impl_.items_game_url_deprecated2013_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void CMsgUpdateItemSchema::set_allocated_items_game_url_deprecated2013(std::string* items_game_url_deprecated2013) {
  if (items_game_url_deprecated2013 != nullptr) {
    _impl_._has_bits_[0] |= 0x00000002u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000002u;
  }
  _impl_.items_game_url_deprecated2013_.SetAllocated(items_game_url_deprecated2013, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.items_game_url_deprecated2013_.IsDefault()) {
    _impl_.items_game_url_deprecated2013_.Set("", GetArenaForAllocation());
  }
