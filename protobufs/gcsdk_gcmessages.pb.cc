...
PROTOBUF_CONSTEXPR CMsgServerHello::CMsgServerHello(
  ...
  , /*decltype(_impl_.client_launcher_)*/0u
  , /*decltype(_impl_.steamdatagram_port_)*/0u} {}
...
static ::_pb::Metadata file_level_metadata_gcsdk_5fgcmessages_2eproto[36];
...
const uint32_t TableStruct_gcsdk_5fgcmessages_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::CMsgServerHello, _impl_.steamdatagram_port_),
  0,
  ~0u,
  1,
  2,
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 34, 45, -1, sizeof(::CMsgSOMultipleObjects)},
  { 50, 58, -1, sizeof(::CMsgSOCacheSubscribed_SubscribedType)},
  { 60, 69, -1, sizeof(::CMsgSOCacheSubscribed)},
  { 72, 79, -1, sizeof(::CMsgSOCacheUnsubscribed)},
  { 80, 88, -1, sizeof(::CMsgSOCacheSubscriptionCheck)},
  { 90, 97, -1, sizeof(::CMsgSOCacheSubscriptionRefresh)},
  { 98, 105, -1, sizeof(::CMsgSOCacheVersion)},
  { 106, 130, -1, sizeof(::CMsgAccountDetails)},
  { 148, 158, -1, sizeof(::CMsgGCMultiplexMessage)},
  { 162, 169, -1, sizeof(::CMsgGCMultiplexMessage_Response)},
  { 170, 178, -1, sizeof(::CGCToGCMsgMasterAck)},
  { 180, 187, -1, sizeof(::CGCToGCMsgMasterAck_Response)},
  { 188, -1, -1, sizeof(::CGCToGCMsgMasterStartupComplete)},
  { 194, 203, -1, sizeof(::CGCToGCMsgRouted)},
  { 206, 214, -1, sizeof(::CGCToGCMsgRoutedReply)},
  { 216, 224, -1, sizeof(::CMsgGCUpdateSessionIP)},
  { 226, 233, -1, sizeof(::CMsgGCRequestSessionIP)},
  { 234, 241, -1, sizeof(::CMsgGCRequestSessionIPResponse)},
  { 242, 250, -1, sizeof(::CMsgSOCacheHaveVersion)},
  { 252, 265, -1, sizeof(::CMsgClientHello)},
  { 272, 283, -1, sizeof(::CMsgServerHello)},
  { 288, 297, -1, sizeof(::CMsgClientWelcome_Location)},
  { 300, 314, -1, sizeof(::CMsgClientWelcome)},
  { 322, 334, -1, sizeof(::CMsgConnectionStatus)},
  { 340, 349, -1, sizeof(::CWorkshop_PopulateItemDescriptions_Request_SingleItemDescription)},
  { 352, 360, -1, sizeof(::CWorkshop_PopulateItemDescriptions_Request_ItemDescriptionsLanguageBlock)},
  { 362, 370, -1, sizeof(::CWorkshop_PopulateItemDescriptions_Request)},
  { 372, 380, -1, sizeof(::CWorkshop_GetContributors_Request)},
  { 382, -1, -1, sizeof(::CWorkshop_GetContributors_Response)},
  { 389, 398, -1, sizeof(::CWorkshop_SetItemPaymentRules_Request_WorkshopItemPaymentRule)},
  { 401, 410, -1, sizeof(::CWorkshop_SetItemPaymentRules_Request_PartnerItemPaymentRule)},
  { 413, 423, -1, sizeof(::CWorkshop_SetItemPaymentRules_Request)},
  { 427, -1, -1, sizeof(::CWorkshop_SetItemPaymentRules_Response)},
};
...
const char descriptor_table_protodef_gcsdk_5fgcmessages_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "kshop_SetItemPaymentRules_Response*_\n\024GC"
  "ClientLauncherType\022 \n\034GCClientLauncherTy"
  "pe_DEFAULT\020\000\022%\n!GCClientLauncherType_PER"
  "FECTWORLD\020\001*\325\001\n\022GCConnectionStatus\022#\n\037GC"
  "ConnectionStatus_HAVE_SESSION\020\000\022$\n GCCon"
  "nectionStatus_GC_GOING_DOWN\020\001\022!\n\035GCConne"
  "ctionStatus_NO_SESSION\020\002\0220\n,GCConnection"
  "Status_NO_SESSION_IN_LOGON_QUEUE\020\003\022\037\n\033GC"
  "ConnectionStatus_NO_STEAM\020\004B\005H\001\200\001\000"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_gcsdk_5fgcmessages_2eproto = {
    false, false, 4434, descriptor_table_protodef_gcsdk_5fgcmessages_2eproto,
    "gcsdk_gcmessages.proto",
    &descriptor_table_gcsdk_5fgcmessages_2eproto_once, descriptor_table_gcsdk_5fgcmessages_2eproto_deps, 1, 36,
...
CMsgClientHello::CMsgClientHello(const CMsgClientHello& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.version_, &from._impl_.version_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.partner_accountflags_) -
    reinterpret_cast<char*>(&_impl_.version_)) + sizeof(_impl_.partner_accountflags_));
...
// @@protoc_insertion_point(message_clear_start:CMsgClientHello)
  ...
  if (cached_has_bits & 0x0000003fu) {
    ::memset(&_impl_.version_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.partner_accountflags_) -
        reinterpret_cast<char*>(&_impl_.version_)) + sizeof(_impl_.partner_accountflags_));
  }
  _impl_._has_bits_.Clear();
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
...
void CMsgClientHello::InternalSwap(CMsgClientHello* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CMsgClientHello, _impl_.partner_accountflags_)
      + sizeof(CMsgClientHello::_impl_.partner_accountflags_)
      - PROTOBUF_FIELD_OFFSET(CMsgClientHello, _impl_.version_)>(
...
class CMsgServerHello::_Internal {
 public:
  ...
  static void set_has_steamdatagram_port(HasBits* has_bits) {
    (*has_bits)[0] |= 8u;
  }
};
...
CMsgServerHello::CMsgServerHello(const CMsgServerHello& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.client_launcher_){}
    , decltype(_impl_.steamdatagram_port_){}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.version_, &from._impl_.version_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.steamdatagram_port_) -
    reinterpret_cast<char*>(&_impl_.version_)) + sizeof(_impl_.steamdatagram_port_));
...
// @@protoc_insertion_point(message_clear_start:CMsgServerHello)
  ...
  if (cached_has_bits & 0x0000000fu) {
    ::memset(&_impl_.version_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.steamdatagram_port_) -
        reinterpret_cast<char*>(&_impl_.version_)) + sizeof(_impl_.steamdatagram_port_));
  }
  _impl_._has_bits_.Clear();
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          _Internal::set_has_steamdatagram_port(&has_bits);
          _impl_.steamdatagram_port_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* CMsgServerHello::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000008u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(5, this->_internal_steamdatagram_port(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:CMsgServerHello)
  ...
  if (cached_has_bits & 0x0000000fu) {
    ...
    // optional uint32 steamdatagram_port = 5;
    if (cached_has_bits & 0x00000008u) {
      total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_steamdatagram_port());
    }
...
void CMsgServerHello::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000000fu) {
    ...
    if (cached_has_bits & 0x00000008u) {
      _this->_impl_.steamdatagram_port_ = from._impl_.steamdatagram_port_;
    }
    _this->_impl_._has_bits_[0] |= cached_has_bits;
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
...
void CMsgServerHello::InternalSwap(CMsgServerHello* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CMsgServerHello, _impl_.steamdatagram_port_)
      + sizeof(CMsgServerHello::_impl_.steamdatagram_port_)
      - PROTOBUF_FIELD_OFFSET(CMsgServerHello, _impl_.version_)>(
          reinterpret_cast<char*>(&_impl_.version_),
          reinterpret_cast<char*>(&other->_impl_.version_));
}
...
void CMsgClientWelcome::InternalSwap(CMsgClientWelcome* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CMsgClientWelcome, _impl_.currency_)
      + sizeof(CMsgClientWelcome::_impl_.currency_)
      - PROTOBUF_FIELD_OFFSET(CMsgClientWelcome, _impl_.location_)>(
...
void CWorkshop_SetItemPaymentRules_Request::InternalSwap(CWorkshop_SetItemPaymentRules_Request* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CWorkshop_SetItemPaymentRules_Request, _impl_.gameitemid_)
      + sizeof(CWorkshop_SetItemPaymentRules_Request::_impl_.gameitemid_)
      - PROTOBUF_FIELD_OFFSET(CWorkshop_SetItemPaymentRules_Request, _impl_.appid_)>(
          reinterpret_cast<char*>(&_impl_.appid_),
          reinterpret_cast<char*>(&other->_impl_.appid_));
}
