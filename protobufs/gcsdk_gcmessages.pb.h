...
constexpr GCClientLauncherType GCClientLauncherType_MAX = GCClientLauncherType_PERFECTWORLD;
...
class CMsgServerHello final :
 ...
 public:
  ...
  enum : int {
    ...
    kClientLauncherFieldNumber = 4,
    kSteamdatagramPortFieldNumber = 5,
  };
  // repeated .CMsgSOCacheHaveVersion socache_have_versions = 2;
  int socache_have_versions_size() const;
  private:
  ...
  uint32_t steamdatagram_port() const;
  void set_steamdatagram_port(uint32_t value);
  private:
  uint32_t _internal_steamdatagram_port() const;
  void _internal_set_steamdatagram_port(uint32_t value);
  public:
...
// optional uint32 steamdatagram_port = 5;
inline bool CMsgServerHello::_internal_has_steamdatagram_port() const {
  bool value = (_impl_._has_bits_[0] & 0x00000008u) != 0;
  return value;
}
...
inline void CMsgServerHello::clear_steamdatagram_port() {
  _impl_.steamdatagram_port_ = 0u;
  _impl_._has_bits_[0] &= ~0x00000008u;
}
inline uint32_t CMsgServerHello::_internal_steamdatagram_port() const {
  return _impl_.steamdatagram_port_;
}
inline uint32_t CMsgServerHello::steamdatagram_port() const {
  // @@protoc_insertion_point(field_get:CMsgServerHello.steamdatagram_port)
  return _internal_steamdatagram_port();
}
inline void CMsgServerHello::_internal_set_steamdatagram_port(uint32_t value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.steamdatagram_port_ = value;
}
inline void CMsgServerHello::set_steamdatagram_port(uint32_t value) {
  _internal_set_steamdatagram_port(value);
  // @@protoc_insertion_point(field_set:CMsgServerHello.steamdatagram_port)
}
